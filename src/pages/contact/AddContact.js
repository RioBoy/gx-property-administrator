                ...
                <div className="row g-3 align-items-center">
                  ...
                  <div className="col-9">
                    ...
                    >
                      ...
                      <option value="cobasaja">Coba Saja</option>
                    </select>
          ...
          <section className="section-2">
            <div className="card bg-white border-0 rounded-2">
              ...
              <div className="card-body">
                ...
                <div className="row g-3 align-items-center">
                  <div className="col-3 d-flex gap-2 align-items-center">
                    <label htmlFor="NPWP" className="col-form-label fw-bold">
                      Tax Number
                    </label>
                  </div>
                  <div className="col-9">
